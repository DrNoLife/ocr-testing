...
{
    public List<string> ProcessImage(string filePath)
    {
    ...
    private void EnsureSpaceForContent(List<string> inputList)
    {
    ...
    private void PreventMultipleSymbolsPrLine(List<string> inputList)
    {
